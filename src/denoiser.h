...
static const char *const HELP = "CG render denoiser based on Intel's Open Image Denoise library.\n\n"
                                "Simply connect your beauty, albedo, and normal inputs and the node will automatically denoise your render.\n\n"
                                "Settings are optimized for best quality by default.";
